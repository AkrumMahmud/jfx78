...
public final class FilteredList<E> extends TransformationList<E, E>{
    ...
    public FilteredList(ObservableList<E> source) {
        this(source, new Callback<E, Boolean>() {
            @Override
    ...
    private final ObjectProperty<Callback<? super E, Boolean>> predicate =
            new ObjectPropertyBase<Callback<? super E, Boolean>>(new Callback<E, Boolean>() {
                @Override
                public Boolean call(E param) {
                    return true;
                }
            }) {
